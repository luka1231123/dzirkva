...
- BGE-M3: MIT.
- ძირკვის კოდი: [GNU AGPL-3.0](LICENSE), © 2026 Luka Rekhviashvili. შეგიძლიათ გამოიყენოთ და შეცვალოთ;
  თუ შეცვლილ ძირკვას ვებ-სერვისად უშვებთ, მისი წყაროს კოდი მომხმარებლებს უნდა მისცეთ.
