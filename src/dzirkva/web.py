...
SIGNS = {
    "small": ("პატარა ვები", "rare", "პირადი საიტი ან ბლოგი, სადაც ავტორი პირველ პირში წერს და არაფერს ყიდის"),
    "academic": ("სამეცნიერო", "", "სამეცნიერო ჟურნალი, უნივერსიტეტის რეპოზიტორია ან ეროვნული ბიბლიოთეკა"),
    "cited": ("ვიკიპედიის წყარო", "", "ამ თემის ვიკიპედიის სტატია ამ გვერდს წყაროდ იყენებს"),
    "old": ("ძველი ვები", "old", "დახურული ქართული საიტის ასლი ინტერნეტ-არქივიდან. ჭდეზე ასლის "
                                 "წელია, უმეტესობა ჩატბოტებზე ადრინდელია"),
...
QUERY_TIPS = [
    "დაწერეთ ისე, როგორც ადამიანს ჰკითხავდით. სიტყვის ფორმაზე ნუ იდარდებთ, ძირკვა სხვა ფორმებსაც ეძებს.",
    "თუ ქართული შრიფტი არ გაქვთ, ლათინური ასოებითაც შეგიძლიათ დაწეროთ. შეცდომას ძირკვა თვითონ ასწორებს "
    "ან სწორ სიტყვას შემოგთავაზებთ.",
    "სამეცნიერო ნაშრომისთვის შეკითხვას დაუმატეთ სიტყვა დისერტაცია ან სტატია, სიტყვის განმარტებისთვის კი "
    "„რას ნიშნავს“.",
    "თუ შეკითხვაში საიტის სახელს ახსენებთ, ამ საიტის გვერდები წინ გამოჩნდება.",
]
GROW = [
...
def home_page() -> str:
    """The start page: why big engines fail Georgian and what dzirkva does, how to write a query,
    when to use ამოძირკვა, how it tells a person's text, finds of the day. Plain Georgian, no example queries."""
    ...
    return (f"<div class='ans hero'><div class=cap>{cap('ქართული ვების საძიებო')}</div>"
            "<span class=t>ძიება ქართულ ვებში</span>"
            "<p class=lead>Google მთელ მსოფლიოზეა გათვლილი. ქართულ შეკითხვაზე სიის თავში ხშირად დიდი პორტალები, "
            "მაღაზიები და ერთი და იმავე სიახლის ასლები ხვდება, ბლოგები, ფორუმები, სამეცნიერო სტატიები და "
            "ბიბლიოთეკის წიგნები კი ქვემოთ იკარგება. ქართულ ბრუნებასა და უღლებასაც ცუდად ერკვევა და ხშირად მხოლოდ "
            ...
            + _block("როგორ ცნობს ადამიანის ტექსტს",
                     "<p>ძირკვა ვერ გაიგებს, ტექსტი ადამიანმა დაწერა თუ მანქანამ, და არც ცდილობს. ის ეძებს ნიშნებს, "
                     "რომ გვერდი ადამიანმა დაწერა ან შეარჩია, და ასეთ გვერდებს წინ აყენებს. შედეგებთან ეს ნიშნები "
                     f"ასე ჩანს:</p><ul class='list signs'>{signs}</ul>"
                     "<p>თუ ერთი ტექსტი რამდენიმე საიტზე დევს, ის ერთ შედეგად ჩანს. ერთ საიტს სიაში ხუთზე მეტი ადგილი "
                     "არ აქვს. ონლაინ-მაღაზიებს ჩვენი ქრაულერი საერთოდ არ აგროვებს.</p>"
